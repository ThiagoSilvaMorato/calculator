...
export interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /**
   * Applies the same visual weight as a real mouse `:active` press.
   * Lets keyboard-triggered input show the identical "pressed" look a
   * click already gets natively, without faking a pointer event.
   */
  pressed?: boolean;
}

const SHARED_CLASSES = 'cursor-pointer rounded-md px-5 py-2.5 font-semibold disabled:cursor-not-allowed';
